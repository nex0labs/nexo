...
//Document Processing
#[no_mangle]
pub extern "system" fn Java_com_nexo_index_TantivyIndex_writerNative(
    mut env: JNIEnv,
    _class: JClass,
    index_path: JString,
) -> jlong {
...
#[no_mangle]
pub extern "system" fn Java_com_nexo_index_TantivyIndex_addDocumentNative(
    mut env: JNIEnv,
...
#[no_mangle]
pub extern "system" fn Java_com_nexo_index_TantivyIndex_commitWriterNative(
    env: JNIEnv,
    _class: JClass,
    handle: jlong,
) -> jint {
...
#[no_mangle]
pub extern "system" fn Java_com_nexo_index_TantivyIndex_closeWriterNative(
    _env: JNIEnv,
    _class: jni::objects::JClass,
    handle: jlong,
) {
